...
dt = 1; %dt, the fineness of the coil readings
...
for temprv = -0.1:0.005:0.2%if change this also change plotx
 % span of readings
    b = b+1
    rv = [temprv 0 0]
    B = [0,0,0];
for a = 0:dt:helixL %going through the helix for one point (dt)
